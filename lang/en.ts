export default {
  ...
  "Explore the various applications of our products":"Explore the various applications of our products",
  "Order Our Products Directly":"Order Our Products Directly",
  "Shop Now":"Shop Now",
  "Inquiries":"Inquiries",
  "Do You Have A Project?":"Do You Have A Project?",
  "We Are Proud to participate in the largest projects in egypt":"We Are Proud to participate in the largest projects in egypt",
  "project files":"Download Project Refrences",
  "all":"All",
  "Research & Development":"Research & Development",
  "Research & Development body":"We focus on the innovation of the current and future products of Rockal to elevate our product line and the quality of our services.",
  "rnd 1":"Al Alamia for insulation has fully equipped scientific research and development center located close to the production site and number of devices to test new materials. Our scientists are focused on the study of performance of building materials, prevention of their aging, increasing the possibilities of application by expanding the operating temperature range, developing additional functions, such as air purification, resistance to moss growth or increasing energy-effectiveness.We have invested in the biggest laboratories in Egypt with a continuous improvement strategy and establishing a learning center and academy for engineers and chemists to gain knowledge and experience in the waterproofing field. ROCKAL’s facilities are equipped with the latest technologies that will offer better quality waterproofing.Laboratories in the factory operate on the basis of modern equipment. It is used to study the physical and mechanical characteristics of materials in a wide temperature range, determine the structure and composition of raw materials and test the durability of materials.",
  "rnd 2":"Unique chromatography equipment is used to determine the composition of bitumen for the production of roofing materials, and optimal selection of type and amount of modifying additives.The research and implementation of advanced technologies allow us to bring new products and product variations depending on the needs of customers each year. For instance, fire safe materials and constructionsystems are one of the major priorities of ROCKAL Corporation. Our roofing and waterproofing membranes fully comply with strict European fire safety regulations.",
  "Here are few examples of the research and development applications inside our labs:":"Here are few examples of the research and development applications inside our labs:",
